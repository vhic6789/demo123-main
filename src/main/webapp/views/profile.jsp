		...
		<div class="col-md-9 border-right">
			<div class="p-3 py-5">
				...
				<c:if test="${status == 1 }">
					<div class="row mt-2">
						<button type="button" class="btn btn-primary"
							data-toggle="collapse" data-target="#demo">Cập nhật ngân
							hàng</button>
						<div id="demo" class="collapse">
							<br>
							<form class="form-inline" action="/user/updatebank" method="POST">
								<label for="namebank" class="mr-sm-2">Tên Ngân Hàng:</label> <input
									name="namebank" type="text" class="form-control mb-2 mr-sm-2"
									placeholder="AGRIBANK" id="namebank"> <label
									for="numbank" class="mr-sm-2">Số tài khoản:</label> <input
									name="numbank" type="text" class="form-control mb-2 mr-sm-2"
									placeholder="0123456789" id="numbank"> <input
				...
				<div class="row mt-3">
					...
					<div class="col-md-12">
						<label class="labels">Thông tin Ngân Hàng</label><input
							type="text" class="form-control" placeholder=""
							value="<c:if test='${status == 1 }'>${sotaikhoan }</c:if>"
							disabled>
					</div>
					...
					<form action="/user/changePwd" method="POST">
						<div class="input-group mb-3">
							<input type="hidden" name="${_csrf.parameterName }"
								value="${_csrf.token }"> <input name="newpassword"
